...
export function DeleteHistoryData():Promise<timer.State>;

export function ExportHistory(arg1:string):Promise<void>;

export function GetReport():Promise<history.Report>;
...
export function SetHistoryConsent(arg1:boolean):Promise<timer.State>;

export function SetHistoryEnabled(arg1:boolean):Promise<timer.State>;
